...
export async function checkForUpdates() {
  // In web build, version is hardcoded
  ...
  try {
    ...
    // Map release assets to install formats (not applicable for web but keep for compatibility)
    const assets = {};
    ...
    // On network or parse error, return no-update (web can't self-update anyway)
    return {
